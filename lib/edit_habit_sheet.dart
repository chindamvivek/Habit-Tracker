...
import 'package:habit_tracker/utils/habit_utils.dart'; // Import utils
...
class EditHabitSheet extends StatefulWidget {
  ...
  const EditHabitSheet({super.key, this.habit, this.onSave, this.onDelete});
...
class _EditHabitSheetState extends State<EditHabitSheet> {
  ...
  void initState() {
    ...
    if (widget.habit != null) {
      ...
      _goalPeriod = widget.habit!.goalPeriod;
      _goalMode = widget.habit!.goalMode;
      _targetReps = widget.habit!.targetReps;

      // Initialize selected interval based on goalPeriod
      if (_goalPeriod == GoalPeriod.weekly) {
        _selectedInterval = "Weekly";
      } else if (_goalPeriod == GoalPeriod.monthly) {
        _selectedInterval = "Monthly";
      } else {
        _selectedInterval = "Every day";
      }

      _weeklyDays = List.from(widget.habit!.weeklyDays);
      _weeklyFrequency = widget.habit!.weeklyFrequency;
                      ...
                      children: [
                        Expanded(
                          child: GestureDetector(
                            onTap: () =>
                                setState(() => _goalType = GoalType.cultivate),
                            child: Container(
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(12),
                          border: Border.all(color: ThemeProvider.primaryBlue),
                        ),
                        child: Row(
                ...
                Transform.scale(
                  ...
                  child: Switch(
                    ...
                    onChanged: (val) {
                      setState(() {
                        if (val) {
                          // Default 30 days from now, but must respect constraints
                          DateTime base = DateTime.now();
                          _endDate = base.add(const Duration(days: 30));
                        } else {
                          _endDate = null;
                        }
                      });
            ...
            Expanded(
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: const Color(
                    0xFFF5F5F7,
                  ).withValues(alpha: 0.5), // Lighter to indicate disabled
                  borderRadius: BorderRadius.circular(16),
                ),
                child: Row(
                  children: [
            ...
            if (_endDate != null) ...[
              ...
              Expanded(
                child: _buildPickerButton(
                  ...
                  onTap: () async {
                    // Min Date is max(startDate, today)
                    ...
                    DateTime minDate = today.isAfter(start) ? today : start;
          ...
          TextButton(
            onPressed: () {
              ...
              if (widget.onDelete != null) {
                ...
                Navigator.pop(context, 'delete'); // Fallback
              }
            },
  ...
  void _saveHabit() {
    ...
    Habit resultAttributes;

    if (widget.habit != null) {
      resultAttributes = widget.habit!.copyWith(
    ...
    if (widget.onSave != null) {
      widget.onSave!(resultAttributes);
      Navigator.pop(context);
    } else {
      Navigator.pop(context, resultAttributes);
    }
  }
